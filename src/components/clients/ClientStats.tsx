...
import { LucideIcon, ArrowUp, ArrowDown, Users, DollarSign, Activity, Clock, CheckCircle, XCircle } from 'lucide-react';
                ...
                <div className="flex items-center justify-between">
                  ...
                  {stat.change !== undefined && (
                    <div className={cn(
                      ...
                      isPositive ? 'bg-emerald-100 text-emerald-800 dark:bg-emerald-900/30 dark:text-emerald-300' : 'bg-rose-100 text-rose-800 dark:bg-rose-900/30 dark:text-rose-300'
                    )}>
                      {isPositive ? (

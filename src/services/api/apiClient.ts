import axios, { AxiosError, AxiosHeaders, AxiosInstance, InternalAxiosRequestConfig, AxiosResponse } from 'axios';
...
console.log('API Base URL:', baseURL, 'Mode:', import.meta.env.MODE);  // Debug log
...
apiClient.interceptors.response.use(
  ...
  async (error: AxiosError) => {
    ...
    console.log('Handling 401 error:', {
      ...
      isRefreshEndpoint: originalRequest.url?.includes('/auth/refresh')
    });
    ...
    try {
      ...
      console.log('=== API CLIENT TOKEN REFRESH ===');
      ...
      if (!authStore.isAuthenticated) {
        console.log('Already logged out, skipping logout call');
